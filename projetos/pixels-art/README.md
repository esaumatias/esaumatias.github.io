...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-016-a-project-pixels-art.git`
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-016-a-project-pixels-art`
...
4. Crie na raiz do projeto os arquivos que você precisará desenvolver:
  * Verifique que você está na raiz do projeto
    * Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/mariazinha/code/**sd-016-a-project-pixels-art**_
...
7. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-016-a-project-pixels-art/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-016-a-project-pixels-art/pulls) e confira que o seu _Pull Request_ está criado
